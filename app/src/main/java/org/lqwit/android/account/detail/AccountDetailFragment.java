...
public class AccountDetailFragment extends AppBaseFragment implements AccountDetailContract.View {
    ...
    public View createView() {
        View root = View.inflate(mActivity, R.layout.fragment_account_detail, null);
    ...
    @Override
    public void setPresenter(@NonNull AccountDetailContract.Presenter presenter) {
